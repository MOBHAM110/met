...
function curl_post_bak($post,$timeout){
...
function dlfile_bak($urlfrom,$urlto,$timeout=30){
	global $checksum;
...
/*短信发送*/
function sendsms($phone,$message,$type){return "SUCCESS";}
function sendsms_bak($phone,$message,$type){
